...
class LidarController: # <--- Renombrar clase
    ...
    def __init__(self, port='/dev/ttyUSB0', data_queue=None, stop_event=None):
        """
    ...
    def _collect_data_loop(self):
        ...
        try:
            ...
            iterator = self.lidar.iter_scan(max_buf_meas=5000)
...
if __name__ == '__main__':
    ...
    # Crear instancia
    lidar_controller = LidarController(port='/dev/ttyUSB0', data_queue=test_data_queue, stop_event=test_stop_event)

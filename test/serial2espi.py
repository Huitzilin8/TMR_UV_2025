...
velocidad = 'stop'  # Ejemplo de valor de velocidad
direccion = 'derecha'   # Ejemplo de valor de dirección
# -----------------------------------------
...
BAUD_RATE = 115200    # Debe coincidir con la configuración en el ESP32
...
try:
    ...
    dato_a_enviar = str(velocidad) + "," + str(direccion) + "\n"

    print("Enviando datos: '" + dato_a_enviar.strip() + "'")
    ser.write(dato_a_enviar.encode('ascii')) # En Python 2, write espera un str (bytes)
